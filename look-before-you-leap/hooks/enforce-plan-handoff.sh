...
output = {
    "hookSpecificOutput": {
        ...
        "additionalContext": (
            ...
            "**BEFORE calling EnterPlanMode**: All codex calls are foreground, "
            "so there should be no stale background tasks. The "
            "guard-handoff-background.sh hook auto-kills any remaining codex "
            "processes and cleans markers. If non-codex background work "
            "exists, use TaskStop for agents.\n\n"
